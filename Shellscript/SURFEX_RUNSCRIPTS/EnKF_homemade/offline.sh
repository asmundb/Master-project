...
if [ "1" -lt "10" ]
then
	cp -f $RUNDIR/RV_001_00PP.DAT ./RV_001.DAT
	cp -f $RUNDIR/RV_002_00PP.DAT ./RV_002.DAT
else
	cp -f $RUNDIR/RV_001_01.DAT ./RV_001.DAT
	cp -f $RUNDIR/RV_002_01.DAT ./RV_002.DAT
fi
...
mv ISBA_PROGNOSTIC.OUT.nc  $RUNDIR/time_series/offline/ISBA_PROGNOSTIC.OUT.nc_20${aa}${mm}${jj}${NT}_ens_PP
